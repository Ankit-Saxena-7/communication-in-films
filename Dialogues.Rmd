...
* Local variables have been prefixed using 'v' (example: vVariable)
* Global variables have been prefixed using 'g' (example: gVariable)
* Paramters to functions have been prefixed using 'p' (example: pParameter)
* Talbles have been prefixed using 'tab' (example: tabDataTable)
